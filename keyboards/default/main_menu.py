...
main_menu_admin.insert(KeyboardButton(text='Удалить услугу'))
main_menu_admin.add(KeyboardButton(text='Добавить мастера'))
main_menu_admin.insert(KeyboardButton(text='Удалить мастера'))
main_menu_admin.add(KeyboardButton(text='Рассылка'))
main_menu_admin.insert(KeyboardButton(text='Удаление записи'))
main_menu_admin.add(KeyboardButton(text='-------------(Кнопки клиента)-------------'))
